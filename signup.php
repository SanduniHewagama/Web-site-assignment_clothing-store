...
<body class="bg">
    ...
    <div id="form-box">
    <form method="post" action="signupactions.php">
        <div class="reg">
            <div class="top">
            ...
            <div class="two-forms">
                <div class="box">
                    <input name="first_name" class="inputb" placeholder="Firstname">
                    <i class="bx bx-user"></i>
                </div>
                <div class="box">
                    <input name="last_name" class="inputb" placeholder="Lastname">
                    <i class="bx bx-user"></i>
                </div>
            </div>
                <div class="box">
                ...
                <input class="box submit" type="submit" value="Register">
        </div>
    </form>
    </div>
